...
For \Ecoli{} mother-machine data\cite{taheri2015,si2019}, maximum-likelihood
estimation yielded $n = 1.05 \pm 0.08$ and $K/\langle\Vbirth\rangle = 8.3 \pm 0.9$,
...
($n = 1.12 \pm 0.11$, $K/\langle\Vbirth\rangle = 7.1 \pm 1.2$),
...
$n = 12.4 \pm 2.1$ and $K/\langle\Vbirth\rangle = 1.08 \pm 0.05$.
...
yielded intermediate parameters: $n = 2.8 \pm 0.6$ and
$K/\langle\Vbirth\rangle = 2.4 \pm 0.4$.
